...
var wasmImports = {
  ...
  /** @export */ I: ___call_sighandler,
  /** @export */ F: ___syscall__newselect,
  /** @export */ s: ___syscall_chdir,
  /** @export */ r: ___syscall_chmod,
  /** @export */ q: ___syscall_dup3,
  /** @export */ t: ___syscall_faccessat,
  /** @export */ M: ___syscall_fadvise64,
  /** @export */ da: ___syscall_fchdir,
  /** @export */ ca: ___syscall_fchmod,
  /** @export */ p: ___syscall_fchmodat2,
  /** @export */ aa: ___syscall_fchown32,
  /** @export */ g: ___syscall_fchownat,
  /** @export */ c: ___syscall_fcntl64,
  /** @export */ $: ___syscall_fdatasync,
  /** @export */ _: ___syscall_fstat64,
  /** @export */ V: ___syscall_ftruncate64,
  /** @export */ U: ___syscall_getcwd,
  /** @export */ H: ___syscall_getdents64,
  /** @export */ i: ___syscall_ioctl,
  /** @export */ X: ___syscall_lstat64,
  /** @export */ m: ___syscall_mkdirat,
  /** @export */ l: ___syscall_mknodat,
  /** @export */ Y: ___syscall_newfstatat,
  /** @export */ e: ___syscall_openat,
  /** @export */ N: ___syscall_pipe,
  /** @export */ k: ___syscall_readlinkat,
  /** @export */ G: ___syscall_renameat,
  /** @export */ j: ___syscall_rmdir,
  /** @export */ Z: ___syscall_stat64,
  /** @export */ E: ___syscall_statfs64,
  /** @export */ C: ___syscall_symlinkat,
  /** @export */ f: ___syscall_unlinkat,
  /** @export */ A: ___syscall_utimensat,
  /** @export */ ia: __abort_js,
  /** @export */ K: __emscripten_get_progname,
  /** @export */ J: __emscripten_runtime_keepalive_clear,
  /** @export */ y: __emscripten_throw_longjmp,
  /** @export */ O: __gmtime_js,
  /** @export */ P: __localtime_js,
  /** @export */ Q: __mktime_js,
  /** @export */ R: __timegm_js,
  /** @export */ ka: __tzset_js,
  /** @export */ ga: _clock_res_get,
  /** @export */ fa: _clock_time_get,
  /** @export */ ea: _emscripten_date_now,
  /** @export */ B: _emscripten_get_heap_max,
...
var ___wasm_call_ctors = wasmExports["ma"];

var _main = Module["_main"] = wasmExports["na"];

var _fflush = wasmExports["pa"];

var _malloc = wasmExports["qa"];

var ___funcs_on_exit = wasmExports["ra"];

var _htonl = wasmExports["sa"];

var _htons = wasmExports["ta"];

var _ntohs = wasmExports["ua"];

var _setThrew = wasmExports["va"];

var __emscripten_stack_restore = wasmExports["wa"];

var __emscripten_stack_alloc = wasmExports["xa"];

var _emscripten_stack_get_current = wasmExports["ya"];
