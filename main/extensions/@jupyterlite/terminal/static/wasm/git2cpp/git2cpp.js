...
function findWasmBinary() {
  return locateFile("git2cpp.wasm");
}
...
function js_delete_request(request_index) {
...
function js_request(url, method, content_type_header, authorization_header, request_timeout_ms, buffer_size) {
  ...
  try {
    ...
    if (!Module["git2cpp_js_cache"]) {
      Module["git2cpp_js_cache"] = {
        "next_index": request_index
      };
    } else {
      request_index = Module["git2cpp_js_cache"]["next_index"]++;
    }
    Module["git2cpp_js_cache"][request_index] = {
      xhr,
      result_buffer_pointer: 0,
      buffer_size
    };
    if (method_js == "GET") {
      xhr.send();
...
function js_maybe_convert_url(url_str) {
...
function js_read(request_index, buffer, buffer_size, first_read, status, status_text, total_bytes, response_headers) {
  try {
    const cache = Module["git2cpp_js_cache"];
...
function js_warning(msg) {
  const msg_js = UTF8ToString(msg);
  console.warning(msg_js);
}

function js_write(request_index, buffer, buffer_size) {
  try {
    const cache = Module["git2cpp_js_cache"];
    const request = cache[request_index];
...
var wasmImports = {
  ...
  /** @export */ t: ___syscall_connect,
  /** @export */ Y: ___syscall_faccessat,
  /** @export */ a: ___syscall_fcntl64,
  /** @export */ V: ___syscall_fstat64,
  /** @export */ P: ___syscall_getcwd,
  /** @export */ B: ___syscall_getdents64,
  /** @export */ r: ___syscall_getsockopt,
  ...
  /** @export */ E: ___syscall_poll,
  /** @export */ z: ___syscall_readlinkat,
  /** @export */ q: ___syscall_recvfrom,
  /** @export */ y: ___syscall_renameat,
  /** @export */ h: ___syscall_rmdir,
  /** @export */ p: ___syscall_sendto,
  /** @export */ g: ___syscall_socket,
  ...
  /** @export */ A: js_base64_encode,
  /** @export */ j: js_delete_request,
  /** @export */ m: js_get_error,
  /** @export */ S: js_maybe_convert_url,
  /** @export */ s: js_read,
  /** @export */ n: js_request,
  /** @export */ _: js_warning,
  /** @export */ o: js_write,
...
var ___wasm_call_ctors = wasmExports["ba"];

var _fflush = wasmExports["ca"];

var _main = Module["_main"] = wasmExports["da"];

var _malloc = wasmExports["ea"];

var _htonl = wasmExports["fa"];

var _ntohs = wasmExports["ga"];

var _htons = wasmExports["ha"];

var ___funcs_on_exit = wasmExports["ia"];

var ___trap = wasmExports["ja"];

var __emscripten_stack_alloc = wasmExports["ka"];
