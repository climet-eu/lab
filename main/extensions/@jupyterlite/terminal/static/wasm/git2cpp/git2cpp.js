...
function js_request(url, method, content_type_header, authorization_header, buffer_size) {
...
function js_read(request_index, buffer, buffer_size, status, status_text, response_headers) {
  try {
    const cache = Module["git2cpp_js_cache"];
