...
declare class PackageManager {
	...
	loadPackageSync(names: string | PyProxy | Array<string>, options?: {
		messageCallback?: (message: string) => void;
		errorCallback?: (message: string) => void;
		checkIntegrity?: boolean;
	}): PackageData[];
	loadPackageInnerSync(names: string | PyProxy | string[], options?: {
		messageCallback?: (message: string) => void;
		errorCallback?: (message: string) => void;
		checkIntegrity?: boolean;
	}): Array<PackageData>;
	...
	setStdout(logger: (message: string) => void): void;
	setStderr(logger: (message: string) => void): void;
}
/**
...
type PackageManagerAPI = Pick<API, "importlib" | "package_loader" | "lockfile_packages" | "bootstrapFinalizedPromise" | "bootstrapFinalizedDone" | "sitepackages" | "defaultLdLibraryPath" | "version"> & {
	config: Pick<PyodideConfigWithDefaults, "packageCacheDir" | "packageBaseUrl" | "cdnUrl">;
};
type PackageManagerModule = Pick<PyodideModule, "PATH" | "LDSO" | "stringToNewUTF8" | "stringToUTF8OnStack" | "_print_stderr" | "_print_stdout" | "stackSave" | "stackRestore" | "_emscripten_dlopen_promise" | "_dlopen" | "getPromise" | "promiseMap" | "_dlerror" | "UTF8ToString">;
...
declare class PyodideAPI_ {
	...
	/** @hidden */
	static loadPackageSync: (names: string | PyProxy | Array<string>, options?: {
		messageCallback?: (message: string) => void;
		errorCallback?: (message: string) => void;
		checkIntegrity?: boolean;
	}) => PackageData[];
	/** @hidden */
	static loadPackageSetStdout: (logger: (message: string) => void) => void;
	/** @hidden */
	static loadPackageSetStderr: (logger: (message: string) => void) => void;
	/** @hidden */
